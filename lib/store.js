...
export function StoreProvider({ children }) {
    ...
    useEffect(() => {
        ...
        const fetchAppData = async () => {
            try {
                ...
                if (configData && configData.value) setRates({ ...initialRates, ...configData.value });
    ...
    return (
        <StoreContext.Provider value={{
            tickets, assets, consumables, deliveries, sfdcCases, lastImportedCases, users, currentUser, rates, expenses, loading,
