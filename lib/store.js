...
export function StoreProvider({ children }) {
    ...
    const addTicket = async (ticket) => {
        ...
        while (attempt < 5) {
            ...
            const dbData = {
                ...
                // salesforce_case: newTicket.salesforceCase — PENDIENTE: columna aún no creada en DB
            };
    ...
    const updateTicket = async (id, updatedData) => {
        try {
            ...
            // if (updatedData.salesforceCase !== undefined) dbUpdate.salesforce_case = ... — PENDIENTE: columna aún no creada en DB
