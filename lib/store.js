...
export function StoreProvider({ children }) {
    ...
    const updateLogisticsTask = async (id, updatedData) => {
        ...
        // Mapeo exhaustivo para evitar pérdida de datos si vienen en snake_case o camelCase
        if (updatedData.status !== undefined) dbUpdate.status = updatedData.status;
        if (updatedData.method !== undefined) dbUpdate.method = updatedData.method;
        
        if (updatedData.delivery_person !== undefined) dbUpdate.delivery_person = updatedData.delivery_person;
        if (updatedData.deliveryPerson !== undefined) dbUpdate.delivery_person = updatedData.deliveryPerson;
        
        if (updatedData.assigned_to !== undefined) dbUpdate.assigned_to = updatedData.assigned_to;
        if (updatedData.assignedTo !== undefined) dbUpdate.assigned_to = updatedData.assignedTo;
        
        if (updatedData.date !== undefined) dbUpdate.date = updatedData.date;
        
        if (updatedData.time_slot !== undefined) dbUpdate.time_slot = updatedData.time_slot;
        if (updatedData.timeSlot !== undefined) dbUpdate.time_slot = updatedData.timeSlot;
        
        if (updatedData.address !== undefined) dbUpdate.address = updatedData.address;
        
        if (updatedData.tracking_number !== undefined) dbUpdate.tracking_number = updatedData.tracking_number;
        if (updatedData.trackingNumber !== undefined) dbUpdate.tracking_number = updatedData.trackingNumber;
        
        if (updatedData.coordinated_by !== undefined) dbUpdate.coordinated_by = updatedData.coordinated_by;
        if (updatedData.coordinatedBy !== undefined) dbUpdate.coordinated_by = updatedData.coordinatedBy;
        
        if (updatedData.assets !== undefined) dbUpdate.assets = updatedData.assets;
        if (updatedData.accessories !== undefined) dbUpdate.accessories = updatedData.accessories;
        if (updatedData.yubikeys !== undefined) dbUpdate.yubikeys = updatedData.yubikeys;
        if (updatedData.delivery_info !== undefined) dbUpdate.delivery_info = updatedData.delivery_info;
        if (updatedData.deliveryInfo !== undefined) dbUpdate.delivery_info = updatedData.deliveryInfo;
        if (updatedData.subject !== undefined) dbUpdate.subject = updatedData.subject;
