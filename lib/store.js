...
export function StoreProvider({ children }) {
    ...
    const updateAsset = async (id, updatedData) => {
        ...
        // Remove camelCase fields and frontend-only fields
        ['hardwareSpec', 'modelNumber', 'partNumber', 'purchaseOrder', 'sfdcCase', 'eolDate', 'imei2', 'boxNumber', 'locationId', 'dateMapped', 'dateLastUpdate', 'updatedBy', 'lastAssetCheck', 'addByUser'].forEach(k => delete dbUpdate[k]);
