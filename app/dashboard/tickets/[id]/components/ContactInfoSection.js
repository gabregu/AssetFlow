                    ...
                    <button
                        onClick={() => {
                            ...
                            if (phone) {
                                ...
                                alert('No hay un número de teléfono registrado para este contacto.');
                            }
                        }}
                        style={{
                            display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '4px 10px', borderRadius: '6px',
                            background: editedData.logistics?.phone ? '#25D366' : '#9ca3af', 
                            color: 'white', fontSize: '0.7rem', fontWeight: 600, border: 'none', cursor: 'pointer',
                            opacity: editedData.logistics?.phone ? 1 : 0.6
                        }}
                        title={!editedData.logistics?.phone ? 'Falta número de teléfono' : ''}
                    >
                    ...
                    <button
                        onClick={() => {
                            ...
                            if (address) {
                                ...
                                alert('No hay una dirección registrada para este contacto.');
                            }
                        }}
                        style={{
                            display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '4px 10px', borderRadius: '6px',
                            background: editedData.logistics?.address ? '#ea4335' : '#9ca3af', 
                            color: 'white', fontSize: '0.7rem', fontWeight: 600, border: 'none', cursor: 'pointer',
                            opacity: editedData.logistics?.address ? 1 : 0.6
                        }}
                        title={!editedData.logistics?.address ? 'Falta dirección' : ''}
                    >
                        <MapPin size={12} /> Mapa
                    </button>
                </div>
